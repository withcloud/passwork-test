        ...
        <div className="flex-1 mt-20">
          <div>
            <div className="flex">
              {abc.map((item) => {
                return (
                  <span key={item} className="mr-4 w-5">
                    {item}
                  </span>
                );
              })}
            ...
            <div className="flex mt-4">
              {compileArr.map((item) => {
                return (
                  <span key={item} className="mr-4 text-red-600 w-5">
                    {item}
                  </span>
                );
              })}
          ...
          <div>
            <button
              className="mr-5 p-2 pl-5 pr-5 bg-blue-500 text-gray-100 text-lg rounded-lg focus:border-4 border-blue-300"
              onClick={() => {
                setAscii(ascii + 1);
